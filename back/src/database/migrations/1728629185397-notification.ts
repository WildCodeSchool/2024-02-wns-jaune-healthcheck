...
export class Notification1728629185397 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `CREATE TABLE "notification" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "is_read" boolean NOT NULL, "content" text NOT NULL, "userId" uuid, CONSTRAINT "PK_705b6c7cdf9b2c2ff7ac7872cb7" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
            `ALTER TABLE "history" ADD "notificationId" uuid`,
        );
        await queryRunner.query(
            `ALTER TABLE "history" ADD CONSTRAINT "UQ_c372a7d47bc824fb157b78121d8" UNIQUE ("notificationId")`,
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "history" DROP CONSTRAINT "UQ_c372a7d47bc824fb157b78121d8"`,
        );
        await queryRunner.query(
            `ALTER TABLE "history" DROP COLUMN "notificationId"`,
        );
