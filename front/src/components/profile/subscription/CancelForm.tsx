...
export default function CancelForm({
    ...
    const [isCancellationValid, setIsCancellationValid] =
                ...
                onCompleted: (data) => {
                    ...
                    setTimeout(() => {
                        ...
                        toast({
                            ...
                            title: "Au revoir !",
                            description:
                                "Votre abonnement est maintenant désactivé.",
                        });
                    }, 3000);
                },
                onError: () => {
            ...
            <DialogContent>
                {showFree && !isCancellationValid && (
                    <>
                        <DialogHeader>
                            <DialogTitle>
                                Êtes-vous sur de vouloir résilier votre
                                abonnement ?
                            </DialogTitle>
                            <DialogDescription>
                ...
                {isCancellationValid && (
                    <>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Vos avantages sont entrain d'être retirés,
